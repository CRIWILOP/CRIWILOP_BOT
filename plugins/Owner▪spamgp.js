...
let handler = async (m, { conn, text, isOwner, usedPrefix, command }) => {
  ...
  let fakegif = { key: {participant: `0@s.whatsapp.net`, ...("6289643739077-1613049930@g.us" ? { remoteJid: "6289643739077-1613049930@g.us" } : {})},message: {"videoMessage": { "title": '🍀❥៚⍣𝘾𝙍𝙄𝙒𝙄𝙇𝙊𝙋_𝘽𝙊𝙏࿐⛦🍀', "h": `Hmm`,'seconds': '99999', 'gifPlayback': 'true', 'caption': 'NyanCatBot estuvo aquí ^~^', 'jpegThumbnail': false }}}
